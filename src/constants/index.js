...
export const paginationItems = [
  {
    ...
    badge: true,
    brand: "Pantum",
    des: "PANTUM Color Laser Printer - Features: Printing - Print Technology: Laser - Paper Size: A4 - Print Speed(Color/B&W): 24 ppm (A4) / 26 ppm (Letter) - Print Resolution: 600 x 600 dpi - Paper Output: 100 pages - Memory: Dual Core, 1 GHz - Duplex Printing: Automatic - First Print Time: Less than 11s - Connectors: High-Speed ​​USB 2.0 Ethernet 10/100/1000 BaseTX (RJ-45) 802.11b/g/n Wireless - Dimensions: 411.2 x 394.1 x 243.7mm - Weight: 16.1 kg - Color: White",
    cat: "Printer",
    pdf: pdf1,
    ficheTech: [
  ...
  },
  {
    ...
    badge: true,
    brand: "Pantum",
    des: "Pantum BM5100fdw Printer laser mono : Pantum BM5100fdw -Printer :laser -monochrome multifonction,:format A4-,4-en-1 avec fonctions impression, copie, numérisation et fax, vitesse d'impression de 40ppm, connexion Réseau :LAN RJ45-, Wifichrome multifonction, format A4, 4-en-1 avec fonctions impression, copie, numérisation et fax, vitesse d'impression de 40ppm, connexion Réseau LAN RJ45, Wifi",
    cat: "Printer",
    pdf: pdf1,
    ficheTech: [
...

  {
    ...
    badge: true,
    brand: "Pantum",
    des: "Printer Monochrome Laser PANTUM BP5100DN : Fonctions Impression - :Capacité Bac à papier 250 pages - :Formats papier -: A4 - Technologie d’impression Laser Monochrome - :Vitesse d’impression Noir & Blanc Jusqu’à 40 pages par minute en A4 -: Résolution 1200 dpi -: Mémoire 512 Mo - Connectivité Ethernet, USB 2.0 -:Auto-Duplex-, Network-Ready : Impression silencieuse - faible encombrement et respectueux de l'environnement -: cartouches à haut rendement en option - processeur haute vitesse 1,2 GHz - Dimensions: 364 x 344 x 257 mm - Poids: 9.3 kg - Garantie: 1 an",
    cat: "Printer",
    pdf: pdf1,
    ficheTech: [
      { label: "Vitesse d'impression ", value: "40ppm(A4)/42ppm(lettre) " },
...

  {
    ...
    ficheTech: [
      ...
      },
      {
        ...
        value:
          "Printer - Cordon d’alimentation - Câble d’interface USB - Plateau de sortie - CD-ROM - Guide de configuration rapide      ",
      },
  ...
  },
  {
    ...
    badge: true,
    brand: "Pantum",
    des: "Printer Laser PANTUM P2509 - Fonctions Impression - Capacité d'impression Jusqu'à :1600 pages - Formats papier: A4 - Technologie d’impression Laser Monochrome - Vitesse d’impression Noir & Blanc: Jusqu’à 22 pages par minute en A4 - Résolution: 1200 dpi - Mémoire: 128 Mo - Connectivité: USB 2.0 - Dimensions: 337 x 220 x 178 mm - Poids: 4.75 kg - Toner recheargeable - Garantie: 1 an",
    cat: "Printer",
    pdf: pdf1,
    ficheTech: [],
  },
...

  {
    ...
    badge: true,
    brand: "Hp",
    des: "Desc : Printer Jet D'Ink HP SMART TANK 516 3en1 Couleur 3YW70A - Fonction: Impression, Copie, Numérisation - Technologie d'impression: jet d'Ink - Vitesse d'impression Noir : Jusqu'à 22 ppm - Vitesse d’impression Couleur : Jusqu'à 16 ppm - Résolution d'impression Couleur : 1200x1200dpi - Format Papier : A4 - Capacité Papier : 100 feuilles -  Cycle d'utilisation (mensuel, A4) : Jusqu'à 1000pages - Connectivité: USB 2.0 haute vitesse, Wi-Fi, Bluetooth LE -  Dimensions: 447 x 373 x 158 mm - Garantie: 1 an",
    cat: "Printer",
    pdf: pdf1,
    ficheTech: [
      ...
      { label: "Ecran Tactile", value: "Non" },
      { label: "Technologie d impression", value: "Jet d'Ink" },
      ...
      { label: "Grammage", value: "75 g/m²" },
      {
        label: "Contenu de L'emballage",
        value:
          "Printer HP Smart Tank 516, Bouteilles d'Ink: 3 x HP GT53XL (noir), 3 x HP GT52 (cyan, magenta et jaune), Notice de précaution pour l'Ink; Fiche pour le ré-emballage et réglementaire RoH-EAC; Cordon d'alimentation, Guide d'installation; Notice PT",
      },
...

  {
    ...
    badge: true,
    brand: "Hp",
    des: "Printer à Réservoir intégré HP Ink Tank 315 - Fonctions: Impression, copier, Numérisation - Format Papier: A4 - Technologie d'impression: jet d'Ink thermique HP - Vitesse d'impression: Jusqu'à 19 ppm (Noir), Jusqu'à 15 ppm (couleur) - Résolution d'impression: 1200 x 1200 dpi(couleur), 4800 x 1200 dpi(noir) - Vitesse de copie(A4, ISO): 6,5 cpm Noir; 2 cpm Couleur - Vitesse de numérisation A4: Jusqu'à 21 secondes - Impression recto verso Manuelle - Formats de fichiers pour la numérisation: JPEG, TIFF, PDF, BMP, PNG - Vitesse du processeur: 360 MHz - Connectivité: USB  - Dimensions: 525 x 310 x 158 mm - Poids: 4,67 kg - Garantie: 1 an",
    cat: "Printer",
    pdf: pdf1,
    ficheTech: [
      { label: "DISPONIBILITÉ", value: "En stock" },
      ...
      { label: "Marque", value: "HP" },
      { label: "Destockage", value: "Non" },
      { label: "Technologie d impression", value: "Multifonction Jet d'Ink" },
      { label: "fonctions", value: "Multifonction" },
      { label: "Impression", value: "Couleur" },
      ...
      },
      {
        ...
        value:
          "Papier ordinaire, papiers photo HP, papier mat pour brochure HP ou papier professionnel HP, papier mat pour présentation HP, papier brillant pour brochure HP ou papier professionnel HP, papiers photo jet d'Ink, papiers mats jet d'Ink, papiers brillant",
      },
      {
        label: "Consommation électrique",
        value:
      ...
      { label: "Grammage", value: "75 g/m²" },
      {
        label: "Contenu de L'emballage",
        value:
          "HP Ink Tank 315 , cartouche d'Ink noire HP GT51 (90CC), cartouche d'Ink cyan HP GT52 (70CC), cartouche d'Ink magenta HP GT52 (70CC), cartouche d'Ink jaune HP GT52 (70CC)",
      },
